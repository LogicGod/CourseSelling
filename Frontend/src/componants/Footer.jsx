...
function Footer() {
  return (
    <div className='p-2 pt-20 lg:pt-24 '>
      <div className='w-[95vw] h-auto p-9 rounded-xl border-2 border-gray-300 shadow-xl lg:w-[75vw] lg:ml-[21vw] lg:h-[auto] lg:flex lg:justify-between lg:p-12 md:w-[65vw] md:ml-[30vw]'>
        <div className='pb-20'>
